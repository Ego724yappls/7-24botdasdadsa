...
exports.run = async (client, message, args) => {
  ...
  message.channel.send("<:ban:791800722689097739> Kullanıcı başarıyla banlandı. <:ban:791800722689097739>")

  const embed = new Discord.MessageEmbed()
    .setColor(0x000000)
    .setTimestamp()
    .addField('<:hm:791801114567245885> Kullanıcı:', `${user.username}#${user.discriminator} (${user.id})`)
    .addField('<:polis:791807842587246614> Yetkili:', `${message.author.username}#${message.author.discriminator}`)
    .addField('<:ban:791800722689097739> Sebep', reason);
