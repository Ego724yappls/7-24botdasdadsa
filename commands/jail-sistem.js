...
message.channel.send(new Discord.MessageEmbed().setColor('#000001').setTitle('Lilu Jail Karantina Sistem').setDescription(`
fb!jail-log [#kanalEtiket]\` **|** fb!jail-log-kapat\`
