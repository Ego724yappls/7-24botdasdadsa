...
if(message.author.id !== message.guild.owner.user.id) return message.channel.send(new Discord.MessageEmbed().setThumbnail(message.author.avatarURL() ? message.author.avatarURL({dynamic: true}) : 'https://cdn.glitch.com/8e70d198-9ddc-40aa-b0c6-ccb4573f14a4%2F6499d2f1c46b106eed1e25892568aa55.png').setImage('https://cdn.discordapp.com/attachments/767026492982689873/785550892254101544/Ekran_Alnts.PNG').setTitle('Bir hata oldu!').setDescription(`• \`${client.ayarlar.prefix}sunucu-kur\` **kullanmak için,** \`Sunucu Sahibi\` **olmanız gerekiyor.**`).addField('Sunucu Sahibi', message.guild.owner.user.tag).setImage('https://cdn.discordapp.com/attachments/767026492982689873/785550892254101544/Ekran_Alnts.PNG'));
...
message.guild.channels.create('§▬▬▬「İnfo」▬▬▬§', {type: 'category'}).then(parent => {
...
message.guild.channels.create('☆▬▬「Text」▬▬☆', {type: 'category'}).then(parent => {
...
message.guild.channels.create('☆▬▬▬▬「Logs」▬▬▬▬☆', {type: 'category'}).then(parent => {
